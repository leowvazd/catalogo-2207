{{-- As variáveis estão chamando métodos próprios de seus objetos ORM
, remover as variáveis para visualizar a tela, ou alimentar as chamadas 
para resolver os erros antes de renderizar novamente --}}
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold text-primary" href="{{ route('home') }}">
                <i class="bi bi-bag-heart-fill me-1"></i> MinhaLoja
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center gap-2">
                    ...
                    @guest
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="btn btn-outline-light btn-sm w-100">Entrar</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('register') }}" class="btn btn-primary btn-sm w-100">Registrar-se</a>
                        </li>
                    @endguest
                    ...
                    @auth
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                <li><a class="dropdown-item" href="{{ route('home') }}"><i class="bi bi-person me-2"></i>Meu Perfil</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <!-- Logout via POST (Breeze Standard) -->
    ...
    <main class="container my-4">
        ...
        <!-- 5. GRID DE PRODUTOS (Responsivo: col-12 col-sm-6 col-md-4 col-lg-3) -->
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center py-5">
                    ...
                    <a href="{{ route('home') }}" class="btn btn-primary btn-sm mt-2">Limpar busca e filtros</a>
                </div>
            @endforelse
        </div>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-bs-theme="auto">
    ...
    <body class="bg-body-tertiary text-body d-flex flex-column min-vh-100 justify-content-center align-items-center p-3 p-md-4">
        
        <header class="w-100 mw-container mb-4">
            @if (Route::has('login'))
                <nav class="d-flex align-items-center justify-content-end gap-2">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-link btn-sm text-decoration-none text-body px-3">
                            Log in
                        </a>
        ...
        <div class="d-flex justify-content-center align-items-center w-100 flex-grow-1">
            <main class="w-100 mw-container">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-body p-4 p-md-5">
                        <h1 class="h4 fw-semibold mb-1">Vamos começar</h1>

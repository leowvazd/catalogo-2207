    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="display-1 fw-bold text-primary mb-3">403</div>
                
                <!-- Mensagem amigável -->
                <h1 class="h3 fw-semibold text-dark mb-2">Ops! Acesso negado.</h1>
                <p class="text-muted mb-4">
                    Parece que você não tem permissão para acessar essa página !!
                </p>
                <p class="text-muted mb-4">
                    Se essa mensagem estiver incorreta, contate o administrador do sistema.
                </p>
